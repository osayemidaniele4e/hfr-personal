...
<div class="latest-area section-padding bg-white">
    <div class="container">
        ...
        <div class="box-header">
            ...
            <form class="form-horizontal"  action="{{route('search.pharmacy')}}" method="GET">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9" >
                        <input class="form-control input-sm"type="text" name="facility_name" id="facility_name" class="form-control" placeholder="Pharmacy name">
                    </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="#">
                                        ...
                                        data-longitude="{{$fac->longitude}}" data-latitude="{{$fac->latitude}}" data-outlet_category="{{ $fac->outlet_category }}" data-premises_type="{{ $fac->premises_type }}"
                                        ...
                                        data-pharmacists_reg_number="{{ $fac->pharmacists_reg_number }}"  data-house_no="{{ $fac->house_no }}" data-ownership_details="{{ $fac->ownership_details }}" data-street_name="{{ $fac->street_name }}"
                                        data-pharmacists="{{$fac->pharmacists}}" data-pharmacy_technicians="{{$fac->pharmacy_technicians}}" >
                                        View
                                    </button>
                                </a> 
                            </td>
