              ...
              <div class="panel-body">
                <form action="{{route('wards.update','id')}}" method="post">
                    ...
                    <div class="form-group row {{ $errors->has('lga_id1') ? 'has-error' : '' }}">            
                            ...
                            <div class="col-sm-8">
                                    <select class="form-control select2" id="lga_id1" name ="lga_id1" required  data-width="100%">
                      ...
                      <div class="form-group row {{ $errors->has('name1') ? 'has-error' : '' }}">
                          <label for="name" class="col-sm-4 control-label">Ward Name: <font color="red">*</font> </label>
                          <div class="col-sm-8">
