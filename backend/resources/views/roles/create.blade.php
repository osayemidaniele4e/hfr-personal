            ...
            <div class="panel-body">
                <div class="box-body">
                    ...
                    <div class="form-group row">
                        <label style="text-align: right;" class="col-md-2 col-form-label text-md-right">Role name:<font
                                color="red">*</font> </label>
                        <div class="col-md-8">
                            <input id="role" type="text" class="form-control" name="name"
                    ...
                    <div class="form-group row">
                        <label style="text-align: right;" class="col-md-2 col-form-label text-md-right">Description:<font
                                color="red">*</font> </label>
                        <div class="col-md-8">
                    ...
                    <div class="form-group row">
                        <label style="text-align: right;" class="col-md-2 col-form-label text-md-right">Subordinate Roles:
                        </label>
                        <div class="col-md-8">
                            <select class="form-control select2" class="form-control" id="roles_below" name="roles_below[]"
                                multiple="multiple" data-placeholder="Select Roles" data-width="100%">
                                @foreach (getRolesAll() as $role)
