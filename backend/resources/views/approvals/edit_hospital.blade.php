                ...
                <div class="panel-body">
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input type="text" class="form-control"  id="state_unique_id" name="state_unique_id" value="{{ $hosp->state_unique_id}}" placeholder="State Unique Identifier">
                            </div>
                        ...
                        <div class="form-group" >
                            <div class="col-sm-6">
                                ...
                                <div class="col-sm-8">
                                <input type="text" class="form-control"  id="facility_name"  name="facility_name" value="{{$hosp->facility_name}}" placeholder="Registered Facility Name">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input type="text" class="form-control"  id="physical_location" name="physical_location" value="{{ $hosp->physical_location}}" placeholder="Not P.O. Box or PMB">
                            </div>
                    ...
                    <div class="form-group">
                            ...
                            <div class="col-sm-2">                               
                                    <input type='checkbox' id='d1' name='operational_days[]' value='Monday' {{ strpos($hosp->operational_days, "Monday") !== false ? "checked":"" }}> Monday
                            </div>
                            <div class="col-sm-2">                               
                                    <input type='checkbox' id='d2' name='operational_days[]' value='Tuesday' {{ strpos($hosp->operational_days, "Tuesday") !== false ? "checked":"" }}> Tuesday
                            </div>
                            <div class="col-sm-2">                               
                                    <input type='checkbox' id='d3' name='operational_days[]' value='Wednesday'{{ strpos($hosp->operational_days, "Wednesday") !== false ? "checked":"" }}> Wednesday
                            </div> 
                    </div>
                    ...
                    <div class="form-group">
                            ...
                            <div class="col-sm-2">                               
                                    <input type='checkbox' id='d4' name='operational_days[]' value='Thursday'{{ strpos($hosp->operational_days, "Thursday") !== false ? "checked":"" }}>Thursday
                            </div> 
                            <div class="col-sm-2">                               
                                    <input type='checkbox' id='d5' name='operational_days[]' value='Friday' {{ strpos($hosp->operational_days, "Friday") !== false ? "checked":"" }}> Friday
                            </div> 
                            <div class="col-sm-2">                               
                                    <input type='checkbox' id='d6' name='operational_days[]' value='Saturday'{{ strpos($hosp->operational_days, "Saturday") !== false ? "checked":"" }} > Saturday
                            </div> 
                            <div class="col-sm-2">                               
                                    <input type='checkbox' id='d7' name='operational_days[]' value='Sunday'{{ strpos($hosp->operational_days, "Sunday") !== false ? "checked":"" }}> Sunday
                            </div> 
                    </div>
            ...
            <div id="collapse2" class="panel-collapse collapse" role="tabpanel" aria-labelledby="heading2">
                <div class="panel-body">
                        <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                        <div class="col-sm-12">                               
                                                <input type='checkbox'name='outpatient' value='Yes' {{ ($hosp->outpatient == 'Yes' ? "checked":"") }}> Out Patient
                                        </div>
                                        <div class="col-sm-12">                               
                                                <input type='checkbox'name='inpatient' value='Yes' {{ ($hosp->inpatient == 'Yes' ? "checked":"") }}> In Patient
                                        </div>
                                </div>
                        </div>
                        <hr size="30">
                                ...
                                <div class="col-sm-9">
                                        @foreach($lst_services as $s)      
                                            @if($s->service_category_id == 1)
                                                <div class="col-sm-4">
                                                    <input type='checkbox' name='services[]' value={{ $s->id }}  {{ (in_array($s->id,$current_services, TRUE) ? "checked":"") }}> {{$s->name}}
                                                </div>
                                            @endif                                       
                                        @endforeach
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <div class="col-sm-4">                               
                                        <input type='checkbox'name='onsite_pharmarcy' value='Yes' {{ ($hosp->onsite_pharmarcy == 'Yes' ? "checked":"") }}> Onsite Pharmacy
                                </div>
                                <div class="col-sm-4">                               
                                        <input type='checkbox'name='onsite_laboratory' value='Yes' {{ ($hosp->onsite_laboratory == 'Yes' ? "checked":"") }}> Onsite Laboratory
                                </div>
                                <div class="col-sm-4">                               
                                        <input type='checkbox'name='mortuary_services' value='Yes'{{ ($hosp->mortuary_services == 'Yes' ? "checked":"") }}> Mortuary Services
                                </div> 
                                <div class="col-sm-4">                               
                                        <input type='checkbox'name='onsite_imaging' value='Yes'{{ ($hosp->onsite_imaging == 'Yes' ? "checked":"") }}> Onsite Imaging/ Radio-Diagnostics Center
                                </div>
                                <div class="col-sm-4">                               
                                        <input type='checkbox'name='ambulance_services' value='Yes'{{ ($hosp->ambulance_services == 'Yes' ? "checked":"") }}> Ambulance Services
                                </div> 
                            </div> 
                        </div>
                        <hr size="30">
                        ...
                        <div class="form-group {{ $errors->has('beds') ? 'has-error' : '' }}" >
                                ...
                                <div class="col-sm-9">
                                        <div class="col-sm-12">                               
                                        <input type="text" class="form-control input-sm"  id="beds" name="beds"  value="{{ $hosp->beds}}">
                                             @if ($errors->has('beds'))
                                            <span class="help-block">
                                                {{ $errors->first('beds') }}
                                            </span>                                 
            ...
            <div class="panel-body">
                        ...
                        <div class="form-group" >
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="col-sm-4">
                                <input type="text" class="form-control input-sm"  id="dentist" name="dentist"  value="{{$hosp->doctors}}">
                        ...
                        <div class="form-group" >
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="col-sm-4">
                                <input type="text" class="form-control input-sm"  id="attendants" name="attendants" value="{{$hosp->attendants}}">
