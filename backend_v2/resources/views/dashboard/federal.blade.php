...
@push('bk_script')
    ...
    <script>
        ...
        Highcharts.chart('facility_status', {
            ...
            colors: ['#2f7ed8', '#C0C0C0', '#DDDF00', '#0d233a', '#BA55D3', '#a6c961', '#64E572', '#50B432',
                '#f28f43', '#ED561B', '#910000'
            ],
            yAxis: {
                min: 0,
                title: {
                                ...
                                $.ajax({
                                    ...
                                    success: function(result) {
                                        $.each(result, function(index, value) {
                                            ...
                                            $('#fac_status_state > tbody:last-child')
                                                .append(row);
                                        });
                                        ...
                                        Highcharts.chart('state_summary', {
                                            ...
                                            colors: ['#2f7ed8', '#C0C0C0', '#DDDF00',
                                                '#0d233a', '#BA55D3', '#a6c961',
                                                '#64E572', '#50B432', '#f28f43',
                                                '#ED561B', '#910000'
                                            ],
                                            yAxis: {
                                                min: 0,
