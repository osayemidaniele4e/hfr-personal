                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-2">
                        <div class="input-group date">
                            ...
                            <input type="text" class="form-control pull-right" id="datepicker" name="from_date"
                                value="{{ $data['from'] }}" autocomplete="off" required>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-2">
                        <div class="input-group date">
                            ...
                            <input type="text" class="form-control pull-right" id="datepicker1" name="to_date"
                                value="{{ $data['to'] }}" autocomplete="off" required>
                        </div>
                    </div>
