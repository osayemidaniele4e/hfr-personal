                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" id="registration_no" name="registration_no"
                                        value="" placeholder="Corporate Affairs Registration Number">
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" id="facility_name" name="facility_name"
                                        value="" placeholder="Registered Facility Name">
                                </div>
                                ...
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" id="alt_facility_name"
                                        name="alt_facility_name" value="" placeholder="Alternate Facility Name">
                                </div>
                            </div>
                                ...
                                <div class="col-sm-4">
                                    <select class="form-control select2" id="ownership_id" name="ownership_id"
                                        ...
                                        @foreach (getOwnership() as $st)
                                            <option value="{{ $st->id }}"
                                                {{ old('ownership_id') == $st->id ? 'selected' : '' }}>{{ $st->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="col-sm-4">
                                    <select class="form-control select2" id="accreditation_status_id"
                                        ...
                                        @foreach (getAccreditationStatus() as $st)
                                            <option value="{{ $st->id }}"
                                                {{ old('accreditation_status_id') == $st->id ? 'selected' : '' }}>
                                                {{ $st->status }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            ...
                            <div class="col-sm-8">
                                <select class="form-control select2" id="premises_type_id" name="premises_type_id"
                                    ...
                                    @foreach (getPremisesType() as $st)
                                        <option value="{{ $st->id }}"
                                            {{ old('premises_type_id') == $st->id ? 'selected' : '' }}>{{ $st->name }}
                                        </option>
                                    @endforeach
                                </select>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" id="medical_laboratory_number"
                                    name="medical_laboratory_number" value=""
