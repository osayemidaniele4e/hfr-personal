        ...
        <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
                    ...
                    <div class="panel-body">
                        <div class="box-body">
                                ...
                                <div class="col-sm-4">
                                    <div class="input-group date">
                                        ...
                                        <input type="text" class="form-control pull-right" id="start_date"
                                            name="start_date" value="{{ $labs->start_date }}" autocomplete="off">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" id="facility_name" name="facility_name"
                                        value="{{ $labs->facility_name }}" placeholder="Registered Facility Name">
                                </div>
                                ...
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" id="alt_facility_name"
                                        name="alt_facility_name" value="{{ $labs->alt_facility_name }}"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" id="postal_address" name="postal_address"
                                        value="{{ $labs->postal_address }}">
                                </div>

                                <label for="phone_number" class="col-sm-2 control-label">Phone Number:</label>
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" id="phone_number" name="phone_number"
                                        value="{{ $labs->phone_number }}">
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-2">
                                    <input type='checkbox' id='d1' name='operational_days[]' value='Monday'
                                        {{ strpos($labs->operational_days, 'Monday') !== false ? 'checked' : '' }}> Monday
                                </div>
                                <div class="col-sm-2">
                                    <input type='checkbox' id='d2' name='operational_days[]' value='Tuesday'
                                        {{ strpos($labs->operational_days, 'Tuesday') !== false ? 'checked' : '' }}>
                                    Tuesday
                                </div>
                                <div class="col-sm-2">
                                    <input type='checkbox' id='d3' name='operational_days[]'
                                        value='Wednesday'{{ strpos($labs->operational_days, 'Wednesday') !== false ? 'checked' : '' }}>
                                    Wednesday
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-2">
                                    <input type='checkbox' id='d4' name='operational_days[]'
                                        value='Thursday'{{ strpos($labs->operational_days, 'Thursday') !== false ? 'checked' : '' }}>Thursday
                                </div>
                                <div class="col-sm-2">
                                    <input type='checkbox' id='d5' name='operational_days[]' value='Friday'
                                        {{ strpos($labs->operational_days, 'Friday') !== false ? 'checked' : '' }}> Friday
                                </div>
                                <div class="col-sm-2">
                                    <input type='checkbox' id='d6' name='operational_days[]'
                                        value='Saturday'{{ strpos($labs->operational_days, 'Saturday') !== false ? 'checked' : '' }}>
                                    Saturday
                                </div>
                                <div class="col-sm-2">
                                    <input type='checkbox' id='d7' name='operational_days[]'
                                        value='Sunday'{{ strpos($labs->operational_days, 'Sunday') !== false ? 'checked' : '' }}>
                                    Sunday
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="operational_hours"
                                        name="operational_hours" value="{{ $labs->operational_hours }}"
                                ...
                                <div class="col-sm-4">
                                    <select class="form-control select2" id="ownership_id" name="ownership_id"
                                        ...
                                        @foreach (getOwnership() as $st)
                                            <option value="{{ $st->id }}"
                                                {{ $labs->ownership_id == $st->id ? 'selected' : '' }}>{{ $st->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="ownership_details"
                                        name="ownership_details" value=" {{ $labs->ownership_details }}">
                                </div>
                            </div>
                                ...
                                <div class="col-sm-4">
                                    <select class="form-control select2" id="operational_status_id"
                                        ...
                                        @foreach (getLabOperationalStatus() as $st)
                                            <option value="{{ $st->id }}"
                                                {{ $labs->operational_status_id == $st->id ? 'selected' : '' }}>
                                                {{ $st->status }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="col-sm-4">
                                    <select class="form-control select2" id="registration_status_id"
                                        ...
                                        @foreach (getlabRegistrationStatus() as $st)
                                            <option value="{{ $st->id }}"
                                                {{ $labs->registration_status_id == $st->id ? 'selected' : '' }}>
                                                {{ $st->status }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <select class="form-control select2" id="accreditation_status_id"
                                        name="accreditation_status_id" style="width: 100%;">
                                        <option value="">--Select Accreditation Status--</option>
                                        @foreach (getAccreditationStatus() as $st)
                                            <option value="{{ $st->id }}"
                                                {{ $labs->accreditation_status_id == $st->id ? 'selected' : '' }}>
                                                {{ $st->status }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="col-sm-4">
                                    <select class="form-control select2" id="license_status_id" name="license_status_id"
                                        ...
                                        @foreach (getLicenseStatus() as $st)
                                            <option value="{{ $st->id }}"
                                                {{ $labs->license_status_id == $st->id ? 'selected' : '' }}>
                                                {{ $st->status }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label">Laboratory Level:<font color="red">*</font>
                                </label></label>
                                <div class="col-sm-4">
                                    <select class="form-control select2" id="facility_level_id" name="facility_level_id"
                                        ...
                                        @foreach (getLevelOfCare() as $st)
                                            <option value="{{ $st->id }}"
                                                {{ $labs->facility_level_id == $st->id ? 'selected' : '' }}>
                                                {{ $st->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
            ...
            <div class="panel panel-default">
                ...
                <div id="collapseFour" class="panel-collapse collapse in" role="tabpanel"
                    ...
                    <div class="panel-body">
                        <div class="form-group">
                            <label class="col-sm-4 control-label">Institution/ Stand Alone:<font color="red"></font>
                            </label>
                            <div class="col-sm-8">
                                <select class="form-control select2" id="premises_type_id" name="premises_type_id"
                                    ...
                                    @foreach (getPremisesType() as $st)
                                        <option value="{{ $st->id }}"
                                            {{ $labs->premises_type_id == $st->id ? 'selected' : '' }}>{{ $st->name }}
                                        </option>
                                    @endforeach
                                </select>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" id="medical_laboratory_number"
                                    name="medical_laboratory_number" value="{{ $labs->medical_laboratory_number }}"
                                    placeholder="Public/Private Medical Laboratory Number">
                            </div>
                        </div>
                        {{--
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <select class="form-control" id="quality_assurance" name="quality_assurance"
                                    style="width: 100%;">
                                    <option value="">--Choose one--</option>
                                    <option value="1" {{ $labs->quality_assurance == 1 ? 'selected' : '' }}>Enrolled
                                    </option>
                                    <option value="2" {{ $labs->quality_assurance == 2 ? 'selected' : '' }}>Not
                                        Enrolled</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" id="laboratory_scientists"
                                    name="laboratory_scientists" value="{{ $labs->laboratory_scientists }}">
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" id="laboratory_technicians"
                                    name="laboratory_technicians" value="{{ $labs->laboratory_technicians }}">
                            </div>
                        </div>
