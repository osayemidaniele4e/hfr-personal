                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                @if (auth()->user()->hasPermissionTo(8))
                                    <a href="javascript:void(0);">
                                        <button class="btn btn-danger btn-sm" data-id="{{ $lab->id }}"
                                            data-name="{{ $lab->facility_name }}" type="button" data-toggle="modal"
...
@push('bk_script')
    ...
    <script>
        ...
        $(document).on('click', '.view-details', function() {
            ...
            $.ajax({
                url: `/admin/laboratory/show/${id}`, // Adjust route as needed
                type: 'GET',
                success: function(response) {
                    $("#dynamicModalContainer").html(response);
                    $("#laboratoryModal" + id).modal("show");
