                  ...
                  <div class="panel-body">
                      <form method="POST" action="{{ route('registeruser') }}" aria-label="{{ __('Register') }}">
                          ...
                          <div class="form-group row">
                              <label for="firstname" class="col-md-4 col-form-label text-md-right">{{ __('Fist Name') }}
                                  <font color="red">*</font>
                              </label>
                          ...
                          <div class="form-group row">
                              <label for="role" class="col-md-4 col-form-label text-md-right">{{ __('User Role') }}
                                  <font color="red">*</font>
                              </label>
                              <div class="col-md-8">
                                  <select class="form-control select2" class="form-control" id="role"
                                      name="role[]" data-placeholder="Select Role" required data-width="100%">
                          ...
                          <div class="form-group row">
                              <label for="state_id"
                                  class="col-md-4 col-form-label text-md-right">{{ __('State Permission') }} <font
                                      color="red">*</font></label>
                              <div class="col-md-8">
                                  <select class="form-control select2" class="form-control" id="state_id"
                                      name="state_id" data-placeholder="Select State" required data-width="100%">
                                      ...
                                      @foreach (getAssignedState() as $s)
                                          <option value="{{ $s->id }}"
                                              {{ $s->id == old('state_id') ? 'selected' : '' }}>{{ $s->name }}
                                          </option>
                                      @endforeach
                                  </select>
                          ...
                          <div class="form-group row">
                              <label for="state_id"
                                  class="col-md-4 col-form-label text-md-right">{{ __('LGA Permission') }} <font
                                      color="red">*</font></label>
                              <div class="col-md-8">
                                  <select class="form-control select2" class="form-control" id="lga_id"
                                      name="lga_id[]" data-placeholder="Select LGA" required data-width="100%">
