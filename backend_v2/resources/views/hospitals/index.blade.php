                            ...
                            <td>
                                ...
                                <a href="javascript:void(0);">
                                    <button class="btn btn-success btn-sm" type="button" data-toggle="modal"
                                        ...
                                        data-operational_hours="{{ $fac->operational_hours }}" {{-- data-operation_status="{{ $fac->operation_status }}" --}}
        ...
        <div class="box-footer">
            ...
            <div class="btn-group pull-right">
                <form class="form-horizontal" action="{{ route('hospitals.export') }}" method="post">
                    ...
                    <input type="hidden" name="lga_id" value="{{ request('lga_id') }}" />
                    <input type="hidden" name="ward_id" value="{{ request('ward_id') }}" />
                    <input type="hidden" name="facility_name" value="{{ request('facility_name') }}" />
                    <input type="hidden" name="geo_codes" value="{{ request('geo_codes') }}" />
                    <input type="hidden" name="facility_level_id" value="{{ request('facility_level_id') }}" />
                    <input type="hidden" name="ownership_id" value="{{ request('ownership_id') }}" />
                    <input type="hidden" name="operational_status_id" value="{{ request('operational_status_id') }}" />
                    <input type="hidden" name="registration_status_id" value="{{ request('registration_status_id') }}" />
                    <input type="hidden" name="license_status_id" value="{{ request('license_status_id') }}" />
