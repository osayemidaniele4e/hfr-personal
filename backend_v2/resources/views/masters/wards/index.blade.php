        ...
        <div class="box-body">
            <form class="form-horizontal" action="{{ route('wards.search') }}" method="get">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <input class="form-control input-sm"type="text" name="ward_name" id="ward_name" class="form-control"
                        ...
                        <tr>
                            ...
                            <td>
                                @if (auth()->user()->hasPermissionTo(57))
                                    <a href="#">
                                        <button class="btn btn-warning btn-sm" data-id="{{ $w->id }}"
                                            data-name="{{ $w->name }}" data-state_id="{{ $w->state_id }}"
                                            data-lga_id="{{ $w->lga_id }}" type="button" data-toggle="modal"
                                            data-target="#editModal">Edit</button>
                                    </a>
                                @endif
                                @if (auth()->user()->hasPermissionTo(58))
                                    <a href="#">
                                        <button class="btn btn-danger btn-sm" data-id="{{ $w->id }}"
                                            data-name="{{ $w->name }}" type="button" data-toggle="modal"
