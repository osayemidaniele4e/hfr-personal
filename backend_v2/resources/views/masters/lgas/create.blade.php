                ...
                <div class="panel-body">
                    <form action="{{ route('lgas.store') }}" method="post">
                        ...
                        <div class="form-group row {{ $errors->has('name') ? 'has-error' : '' }}">
                            <label for="name" class="col-sm-4 control-label">LGA Name: <font color="red">*</font>
                            </label>
                            <div class="col-sm-8">
                        ...
                        <div class="form-group row {{ $errors->has('lga_code') ? 'has-error' : '' }}">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" id="lga_code" name="lga_code"
                                    placeholder="Two digit numeric code" required>
