                ...
                <div class="form-group">
                    ...
                    <div class="col-md-3">
                        <select class="form-control select2" class="form-control" name="status" data-width="100%">
                            <option value="1" {{ '1' == old('status') ? 'selected' : '' }}>My Pending Publications
                            </option>
                            <option value="2" {{ '2' == old('status') ? 'selected' : '' }}>My Accepted Publications
                            </option>
                            <option value="3" {{ '3' == old('status') ? 'selected' : '' }}>My Rejected Publications
                            </option>
                        </select>
                    </div>
                    <div class="col-sm-1">
                        ...
                        @foreach ($pending as $p)
                            <tr>
                                ...
                                <td>
                                    ...
                                    @endif
                                    <Strong>Date:
                                    </Strong>{{ $p->verified_at ? date('d M Y', strtotime($p->verified_at)) : '' }} <br>
                                ...
                                <td>
                                    ...
                                    @endif
                                    <Strong>Date:
                                    </Strong>{{ $p->validated_at ? date('d M Y', strtotime($p->validated_at)) : '' }} <br>
                                    <Strong>By: </Strong>{{ $p->validated_by }} <br>
                                    <Strong>E-mail: </Strong>{{ $p->validated_email }} <br>
                                    <Strong>Mobile: </Strong>{{ $p->validated_mobile }} <br>
                                    <font color="MediumSeaGreen"><Strong>Remarks: </Strong> </font> {{ $p->validate_note }}
                                    <br>
                                ...
                                <td>
                                    @if ($p->published_by != '')
                                        ...
                                        @endif
                                        <Strong>Date: </Strong>
                                        {{ $p->published_at ? date('d M Y', strtotime($p->published_at)) : '' }} <br>
