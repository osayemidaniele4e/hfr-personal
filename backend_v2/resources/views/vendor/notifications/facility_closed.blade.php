...
<head>
    ...
    <title>{{ config('app.name') }} - Facility Closed</title>
</head>
    ...
    <tr>
        <td style="padding: 20px;">
            <table align="center" cellpadding="0" cellspacing="0" width="600"
                ...
                <tr>
                    <td align="center"
                        style="padding: 10px 30px; background: #6B7280; border-radius: 4px; color: #fff;
                ...
                <tr>
                    <td align="center" style="padding: 20px 30px;">
                        ...
                        <p style="font-size: 16px; color: #333;">
                            A facility has been closed in DHIS2 and removed from HFR.
                        </p>

                        <p style="font-size: 16px; color: #333; text-align:left; margin-top: 10px;">
                            Closed Facility Details:
                        </p>
                        ...
                        <p style="font-size: 16px; color: #333; margin-top: 20px;">
                            This facility has been reported closed previously in DHIS2 and is now removed from HFR as well.
                        </p>

                        <p style="margin-top: 20px;">
                            Kindly take note and take any required follow-up actions if necessary.
                        </p>
                    </td>
                </tr>
