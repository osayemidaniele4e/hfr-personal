...
<head>
    ...
    <title>{{ config('app.name') }} - Facility Deleted</title>
</head>
    ...
    <tr>
        <td style="padding: 20px;">
            <table align="center" cellpadding="0" cellspacing="0" width="600"
                ...
                <tr>
                    <td align="center"
                        style="padding: 10px 30px; background: #EF4444; border-radius: 4px; color: #fff;
                ...
                <tr>
                    <td align="center" style="padding: 20px 30px;">
                        ...
                        <p style="font-size: 16px; color: #333;">
                            A facility has been deleted in DHIS2.
                        </p>

                        <p style="font-size: 16px; color: #333; text-align:left; margin-top: 10px;">
                            Details of the deleted facility:
                        </p>
                        ...
                        <p style="font-size: 16px; color: #333; margin-top: 20px;">
                            This action may require further updates on your end.
                        </p>

                        <p style="margin-top: 20px;">
                            If you did not expect this deletion, kindly investigate accordingly.
                        </p>
                    </td>
                </tr>
