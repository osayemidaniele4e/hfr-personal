                ...
                <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
                    <div class="panel-body">
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" id="registration_no" name="registration_no"
                                        value="{{ $imagings->registration_no }}"
                                ...
                                <div class="col-sm-4">
                                    <div class="input-group date">
                                        ...
                                        <input type="text" class="form-control pull-right" id="start_date"
                                            name="start_date" value="{{ $imagings->start_date }}" autocomplete="off">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" id="facility_name" name="facility_name"
                                        value="{{ $imagings->facility_name }}" placeholder="Registered Facility Name">
                                </div>
                                ...
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" id="alt_facility_name"
                                        name="alt_facility_name" value="{{ $imagings->alt_facility_name }}"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" id="latitude" name="latitude"
                                        value="{{ $imagings->latitude }}">
                                </div>

                                <label for="longitude" class="col-sm-2 control-label">Longitude:</label>
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" id="longitude" name="longitude"
                                        value="{{ $imagings->longitude }}">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" id="postal_address" name="postal_address"
                                        value="{{ $imagings->postal_address }}">
                                </div>

                                <label for="phone_number" class="col-sm-2 control-label">Phone Number:</label>
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" id="phone_number" name="phone_number"
                                        value="{{ $imagings->phone_number }}">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" id="email_address" name="email_address"
                                        value="{{ $imagings->email_address }}">
                                </div>

                                <label for="website" class="col-sm-2 control-label">Website:</label>
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" id="website" name="website"
                                        value="{{ $imagings->website }}">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-2">
                                    <input type='checkbox' id='d1' name='operational_days[]' value='Monday'
                                        {{ strpos($imagings->operational_days, 'Monday') !== false ? 'checked' : '' }}>
                                    Monday
                                </div>
                                <div class="col-sm-2">
                                    <input type='checkbox' id='d2' name='operational_days[]' value='Tuesday'
                                        {{ strpos($imagings->operational_days, 'Tuesday') !== false ? 'checked' : '' }}>
                                    Tuesday
                                </div>
                                <div class="col-sm-2">
                                    <input type='checkbox' id='d3' name='operational_days[]'
                                        value='Wednesday'{{ strpos($imagings->operational_days, 'Wednesday') !== false ? 'checked' : '' }}>
                                    Wednesday
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-2">
                                    <input type='checkbox' id='d4' name='operational_days[]'
                                        value='Thursday'{{ strpos($imagings->operational_days, 'Thursday') !== false ? 'checked' : '' }}>Thursday
                                </div>
                                <div class="col-sm-2">
                                    <input type='checkbox' id='d5' name='operational_days[]' value='Friday'
                                        {{ strpos($imagings->operational_days, 'Friday') !== false ? 'checked' : '' }}>
                                    Friday
                                </div>
                                <div class="col-sm-2">
                                    <input type='checkbox' id='d6' name='operational_days[]'
                                        value='Saturday'{{ strpos($imagings->operational_days, 'Saturday') !== false ? 'checked' : '' }}>
                                    Saturday
                                </div>
                                <div class="col-sm-2">
                                    <input type='checkbox' id='d7' name='operational_days[]'
                                        value='Sunday'{{ strpos($imagings->operational_days, 'Sunday') !== false ? 'checked' : '' }}>
                                    Sunday
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="operational_hours"
                                        name="operational_hours" value="{{ $imagings->operational_hours }}"
                                ...
                                <div class="col-sm-4">
                                    <select class="form-control select2" id="ownership_id" name="ownership_id"
                                        ...
                                        @foreach (getOwnership() as $st)
                                            <option value="{{ $st->id }}"
                                                {{ $imagings->ownership_id == $st->id ? 'selected' : '' }}>
                                                {{ $st->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="ownership_details"
                                        name="ownership_details" value="{{ $imagings->ownership_details }}">
                                </div>
                            </div>
                                ...
                                <div class="col-sm-4">
                                    <select class="form-control select2" id="registration_status_id"
                                        ...
                                        @foreach (getRegistrationStatus() as $st)
                                            <option value="{{ $st->id }}"
                                                {{ $imagings->registration_status_id == $st->id ? 'selected' : '' }}>
                                                {{ $st->status }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="col-sm-4">
                                    <select class="form-control select2" id="license_status_id" name="license_status_id"
                                        ...
                                        @foreach (getLicenseStatus() as $st)
                                            <option value="{{ $st->id }}"
                                                {{ $imagings->license_status_id == $st->id ? 'selected' : '' }}>
                                                {{ $st->status }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label">Institution/ Stand Alone:<font color="red">
                                    </font> </label>
                                <div class="col-sm-10">
                                    <select class="form-control select2" id="premises_type_id" name="premises_type_id"
                                        style="width: 100%;">
                                        ...
                                        @foreach (getPremisesType() as $st)
                                            <option value="{{ $st->id }}"
                                                {{ $imagings->premises_type_id == $st->id ? 'selected' : '' }}>
                                                {{ $st->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" id="radiographers_reg_number"
                                        name="radiographers_reg_number" value="{{ $imagings->radiographers_reg_number }}"
                                        placeholder="Radiographers Council Physical Premise Registration Number">
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" id="radiographers" name="radiographers"
                                        value="{{ $imagings->radiographers }}">
                                </div>


                                <label class="col-sm-2 control-label">Number of Radiography Technicians:</label>
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" id="radiography_tech"
                                        name="radiography_tech" value="{{ $imagings->radiography_tech }}">
                                </div>
                            </div>
...
@push('bk_script')
    ...
    <script>
        ...
        //ownership type
        var own_id = "{{ $imagings->ownership_id }}";
        if (own_id != "") {
            ...
            $.ajax({
                ...
                success: function(result) {
                    ...
                    $('#ownership_type_id').val({{ $imagings->ownership_type_id }});
                }
            })
        }
    </script>
