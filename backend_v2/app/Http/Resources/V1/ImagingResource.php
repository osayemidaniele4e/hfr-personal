        ...
        return [
            ...
            'status' => [
                'operational' => [
                    ...
                    'name' => $this->operational_status ?? $this->operational_status_name ?? null,
                ],
                'registration' => [
                    'id' => $this->registration_status_id ?? null,
                    'name' => $this->registration_status ?? $this->registration_status_name ?? null,
                ],
                'license' => [
                    'id' => $this->license_status_id ?? null,
                    'name' => $this->license_status ?? $this->license_status_name ?? null,
                ],
            ],
