...
class UpdatedRecordsController extends Controller
{
    ...
    public function updatedRecords($id, $stage)
    {
        ...
        $lookup = array(
            ...
            "Alternate Facility Name" => "alt_facility_name",
            "State" => "state_id",
            "LGA" => "lga_id",
            "Ward" => "ward_id",
            "Ownership" => "ownership_id",
            "Ownership Type" => "ownership_type_id",
            "Hospital/ Clinic Level" => "facility_level_id",
            "Facility Level Options" => "facility_level_option_id",
            "Specialized Options" => "facility_level_options_category_id",
            "Longitude" => "longitude",
            "Latitude" => "latitude",
            "Postal Address" => "postal_address",
            "Phone Number" => "phone_number",
            "Facility Close Date" => "close_date",
            "Email Address" => "email_address",
            "Website" => "website",
            "Days of Operation" => "operational_days",
            "Hours of Operation" => "operational_hours",
            "Operation Status" => "operational_status_id",
            "Registration Status" => "registration_status_id",
            "License Status" => "license_status_id",
            "Medical Doctors" => "doctors",
            "Pharmacists" => "pharmacists",
            "Out Patient" => "outpatient",
            "Dentists" => "dentist",
            "Pharmacy Technicians" => "pharmacy_technicians",
            "Number of Nurses (Single Qualified)" => "nurses",
            "Laboratory Scientists" => "lab_scientists",
            "In Patient" => "inpatient",
            "Number of Midwifes (Single Qualified)" => "midwifes",
            "Laboratory Technicians" => "lab_technicians",
            "Number of Nurse and Midwife (Double Qualified)" => "nurse_midwife",
            "Health Records/HIM Officers" => "him_officers",
            "Community Health Officer" => "community_health_officer",
            "Community Health Extension Worker" => "community_extension_workers",
            "Junior Com Health Extension Worker" => "jun_community_extension_worker",
            "Dental Technicians" => "dental_technicians",
            "Environmental Health Officers" => "env_health_officers",
            "Physical Location" => "physical_location",
            "Alternate Number" => "alternate_number",
            "Total number of Beds" => "beds",
            "Onsite Laboratory" => "onsite_laboratory",
            "Number of Health Attendant/Assistant" => "attendants",
            "State Unique ID" => "state_unique_id",
            "Onsite Imaging/ Radio-Diagnostics Center" => "onsite_imaging",
            "Onsite Pharmacy" => "onsite_pharmarcy",
            "Mortuary Services" => "mortuary_services",
