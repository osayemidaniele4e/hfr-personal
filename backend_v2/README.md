...
To create the required database views, run the following SQL commands:
...
-- Create facility_status_lga_pivot view
...
-- Create facility_status_state_pivot view
...
GROUP BY
  h.state_id, s.name;
-- Create hospital_status_tracking view
...
-- Create hospitals_count_by_level_lga view
...
-- Create hospitals_count_by_level_lga_column view
...
-- Create hospitals_count_by_level_state view
...
-- Create hospitals_count_by_level_state_column view
...
-- Create hospitals_count_by_ownership_state view
...
-- Create hospitals_count_by_ownership_state_column view
...
JOIN lst_ownerships o ON h.ownership_id = o.id
GROUP BY s.id, s.name;
-- Create imaging_count_by_ownership_lga view
...
-- Create imaging_count_by_ownership_lga_column view
...
-- Create imaging_count_by_ownership_state view
...
WHERE h.onsite_imaging = 'Yes'
GROUP BY s.id, s.name, o.name;
-- Create imaging_count_by_ownership_state_column view
...
WHERE h.onsite_imaging = 'Yes'
GROUP BY s.id, s.name;
-- Create hospitals_count_by_ownership_level_lga view
...
JOIN lst_level_of_care fl ON h.facility_level_id = fl.id
GROUP BY s.id, s.name, l.id, l.name;
-- Create hospitals_count_by_ownership_level_state view
...
-- Create hospitals_count_by_ownership_level_state_column view
...
JOIN lst_level_of_care fl ON h.facility_level_id = fl.id
GROUP BY s.id, s.name;
-- Create hospitals_count_by_ownership_lga view
...
JOIN lst_ownerships o ON h.ownership_id = o.id
GROUP BY s.id, s.name, l.id, l.name, o.name;
-- Create hospitals_count_by_ownership_lga_column view
...
-- Create laboratory_count_by_level_lga view
...
-- Create laboratory_count_by_level_lga_column view
...
JOIN lst_level_of_care fl ON lab.facility_level_id = fl.id
GROUP BY s.id, s.name, l.id, l.name;
-- Create laboratory_count_by_level_state view
...
JOIN lst_level_of_care fl ON lab.facility_level_id = fl.id
GROUP BY s.id, s.name, fl.name;
-- Create laboratory_count_by_level_state_column view
...
JOIN lst_level_of_care fl ON lab.facility_level_id = fl.id
GROUP BY s.id, s.name;
-- Create laboratory_count_by_ownership_lga view
...
GROUP BY s.id, s.name, l.id, l.name, o.name;
-- Create laboratory_count_by_ownership_lga_column view
...
JOIN lst_ownerships o ON lab.ownership_id = o.id
GROUP BY s.id, s.name, l.id, l.name;
-- Create laboratory_count_by_ownership_state view
...
JOIN lst_ownerships o ON lab.ownership_id = o.id
GROUP BY s.id, s.name, o.name;
-- Create laboratory_details view
...
-- Create pharmacy_count_by_ownership_lga view
...
GROUP BY s.id, s.name, l.id, l.name, o.name;
-- Create pharmacy_count_by_ownership_lga_column view
...
JOIN lst_ownerships o ON p.ownership_id = o.id
GROUP BY s.id, s.name, l.id, l.name;
-- Create pharmacy_count_by_ownership_state view
...
JOIN lst_ownerships o ON p.ownership_id = o.id
GROUP BY s.id, s.name, o.name;
-- Create pharmacy_count_by_ownership_state_column view
